      ...
      <div className="modal">
        <div className="">
          ...
          <div className="mt-4">
            {fundingOption === "Statement" && (
              <p>
                ...
                {ds160Review.financial === "Statement"
                  ? "bank statement"
                  : ds160Review.financial === "Loan"
                  ? "loan"
                  : ds160Review.financial}{" "}
                for your visa processing. Is this still the case?{" "}
                <i>
                  <br />
          ...
          <div className="col mt-3">
            <label className="">Your response:</label>
            <Select
              value={response}
