...
type Props = { label: string; ctaLabel: string; to: string; helper?: string };
...
const NextActionCard: React.FC<Props> = ({ label, ctaLabel, to, helper }) => {
  return (
    <div className="card col justify-between p-4 min-h-[120px]">
      ...
      <Link to={to} className="mt-2 inline-flex items-center gap-1 text-primary-main hover:underline text-sm">
