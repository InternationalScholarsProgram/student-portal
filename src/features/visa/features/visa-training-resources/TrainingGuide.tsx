...
function TrainingGuide() {
  return (
    <div>
      <h3>Visa interview training resources</h3>
      <p>Please read the following instructions carefully:</p>
      <Accordion title="Visa Interview Training Resources" >
        <li>
          ...
          This experience constantly changes depending on the circumstances at
          the embassy, and these visa interview transcripts capture the most
          current trend.
        </li>
        <li>
        ...
        <li>
          ...
          you read or watch it through to the end. Clicking on Next will load
          the next resource.
        </li>
        <li>
        ...
        <p>
          Note: It is mandatory to request and attend the mock visa interview.
          You are required to score at least 80% in your mock visa interview for
          the Program to pay your SEVIS fee.
        </p>
      </Accordion>
    </div>
  );
