...
function UpgradeVersion({ message }: { message: any }) {
  ...
  const contractUrl =
    "https://finkapinternational.qhtestingserver.com/login/member/dashboard/contract_shift.php?";
      ...
      <section className="col card gap-4 p-4">
        ...
        <div className="row-center flex-wrap">
          ...
          <div className="flex-1 row justify-end gap-3">
            <Link to="/portal/create-ticket" className="text-btn">
              Contact Support
            </Link>
