...
const Meeting = () => {
  const { user, status } = useAdmissions();
      ...
      <main>
        ...
        <section className="card col p-3 gap-3">
          ...
          <p>
            ...
            <strong> School Application Consent/Agreement Contract.</strong> This
            document outlines the terms and conditions related to your
            application, including your responsibilities, expectations, and data protection policies.
          </p>
          <p>
            By signing this agreement, you will confirm that you understand and agree
            to the admission policies, financial obligations, and any other
            applicable terms stated in the contract. This is a mandatory step to
            ensure a smooth processing of your application.
          </p>
          <p>
