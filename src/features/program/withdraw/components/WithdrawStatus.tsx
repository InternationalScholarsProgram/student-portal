      ...
      return (
        <div className="col gap-5">
          ...
          <p>
            ...
            statement below. Once you confirm everything looks good, please
            submit your withdrawal request, and wait for our team to respond.
            Please note, all withdrawals are processed on priority as received
            and it can take up to four(4) months for a refund (if any) to be
            made.
          </p>
          ...
          return (
            <div className="col gap-2">
              ...
              <p>
                ...
                statement and decline, otherwise, you must review and confirm
                that the statement is correct for the withdrawal to be
                finalized.
              </p>
              <p>
          ...
          return (
            <div className="col gap-2">
              ...
              <p>
                ...
                confirmation through your personal email. This process can take
                up to 4 months.
              </p>
            </div>
          );
