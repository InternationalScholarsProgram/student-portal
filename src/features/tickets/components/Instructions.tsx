...
function Instructions() {
  return (
    <Accordion title="Tickects Guide">
      <li>
        Always explain your concern in detail. Not providing details will result
        in the technical support team asking questions to understand your
        concern, thus prolonging the issue.
      </li>
      <li>
      ...
      <li>
        ...
        always check for feedback from the technical team by opening the ticket.
      </li>
      <li>
